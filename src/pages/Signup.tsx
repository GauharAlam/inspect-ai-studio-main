...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Welcome to AI CSS Inspector!",
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">Create your account to unlock AI-powered design insights</p>
        </div>
        ...
        <Card className="tech-border bg-card/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>
              Join thousands of designers using AI CSS Inspector
            </CardDescription>
          </CardHeader>
          <CardContent>
